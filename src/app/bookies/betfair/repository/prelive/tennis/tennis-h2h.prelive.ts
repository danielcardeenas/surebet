...
const TENNIS_URL =
  'https://www.betfair.com/exchange/plus/es/tenis-apuestas-2/today';

/**
 * Tennis h2h retriever for Betfair
 */
export class PreliveTennisH2H {
  constructor() {}
  ...
  private static async eventRows(page: Page) {
    ...
    return page.$$(
      'bf-coupon-table:nth-child(2) table tbody tr:not(.coupon-table-loading)',
    );
  }
