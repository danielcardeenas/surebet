...
const MMA_URL =
  'https://www.betfair.com/exchange/plus/es/artes-marciales-mixtas-apuestas-26420387';

/**
 * MMA h2h retriever for Betfair
 */
export class MMAH2H {
  constructor() {}
  ...
  /**
   * Loads mma matches in the browser
   * @param page
   * @param browser
   */
